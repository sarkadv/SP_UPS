...
# trida pro ramec, ve kterem je mozne se zaradit do fronty
class EnqueueFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.button_queue = tk.Button(self, text="Queue", command=lambda: controller.try_queue())
        self.button_queue.pack(padx=150, pady=30)

        self.button_disconnect = tk.Button(self, text="Disconnect", command=lambda: controller.disconnect())
        self.button_disconnect.pack(padx=10, pady=30)
